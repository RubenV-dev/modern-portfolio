    ...
    return (
        ...
        <div className="card-container">
            <div className="proj-card">
                ...
                <p>Built with: <span className="yellow-text">Typescript, React</span></p>
        ...
        <div className="card-container">
            <div className="proj-card">
                    ...
                    <p>Built with: <span className="yellow-text">React, Redux, Hooks, React-vis, Ruby on Rails</span>.</p>
            ...
            <div className="proj-card">
                ...
                <p>
                    Built with: <span className="yellow-text">Javascript, Ruby on Rails, HTML Canvas</span>.
                </p>
